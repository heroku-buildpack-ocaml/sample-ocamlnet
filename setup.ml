...
(* OASIS_START *)
(* DO NOT EDIT (digest: 67e552c705edf4de954bf8b96162a41d) *)
(*
...
let setup_t =
  {
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends = [FindlibPackage ("nethttpd", None)];
     ...
     oasis_version = "0.3.0";
     oasis_digest =
       Some "\227d\169\205\148\237\246\134\004`Hc\145\024\000\024";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
